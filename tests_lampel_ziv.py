...
class TestLempelZiv(unittest.TestCase):
    ...
    #     data = bitarray('11111')
    #     result_1 = lampel_ziv(data, 1)
    #     result_2 = lampel_ziv(data, 2)
    #     result_3 = lampel_ziv(data, 3)
