...
class TestLempelZiv(unittest.TestCase):
    ...
    def test_empty_data(self):
        ...
        data = bitarray()
        result = convert_binarray_to_lampel_ziv_list(data, 1, 1)
    ...
    def test_longer_matches_length_2(self):
        ...
        data = bitarray('10101')
        result = convert_binarray_to_lampel_ziv_list(data, 2, 2)
    ...
    #     data = bitarray('11111')
    #     result = convert_binarray_to_lampel_ziv_list(data, 3, 3)
    ...
    #     data = bitarray('11111')
    #     result_1 = convert_binarray_to_lampel_ziv_list(data, 1, 1)
    #     result_2 = convert_binarray_to_lampel_ziv_list(data, 2, 2)
    #     result_3 = convert_binarray_to_lampel_ziv_list(data, 3, 3)
